...
async function askAssist(id: string, evidence: { problem: Row; events: Row[] }): Promise<string> {
  ...
  // Keep the request body text small. The evidence is supplied through the
  // supplementary context; duplicating it in body.text can exceed the Assist
  // API 10,000-character text limit and causes HTTP 540 Execution crashed.
