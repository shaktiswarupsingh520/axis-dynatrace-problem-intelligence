...
const normalizeRows = (value: unknown): Row[] => {
  ...
  return value.filter((record): record is Row => record !== null && typeof record === 'object' && !Array.isArray(record));
};
