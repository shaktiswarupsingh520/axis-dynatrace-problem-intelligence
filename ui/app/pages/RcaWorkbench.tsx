...
const CSS = [
  '@page{size:A4 portrait;margin:0}','*{box-sizing:border-box}','html,body{margin:0;padding:0;background:#fff;color:#172334;font-family:Arial,Helvetica,sans-serif;font-size:10px;line-height:1.45}',
  '.page{width:210mm;min-height:297mm;position:relative;page-break-after:always;background:#fff;padding:23mm 16mm 18mm}','.page:last-child{page-break-after:auto}',
  ...
  '.cover .metric:first-child{background:#f26a6a;color:#fff}','.cover .metric:first-child span{color:#fff}','.cover-window{display:grid;grid-template-columns:34mm 1fr;gap:3mm 5mm;margin-top:9mm;font-size:8.5px}',
  '.cover-window b{color:#91a1b8;font-size:7px;text-transform:uppercase}','.cover-window span{font-weight:700}','.cover-foot{position:absolute;left:17mm;right:17mm;bottom:14mm;color:#91a1b8;font-size:7.5px}','.cover-foot span{float:right}',
  ...
  '.info-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:3mm;margin-bottom:5mm}','.info-grid>div{border:1px solid #dbe3ec;border-radius:4px;padding:3.5mm;background:#f7f9fc;min-height:15mm}',
  '.info-grid b{display:block;margin-top:2mm;font-size:10px}','.blue{color:#2861c7}','.finding{border:1px solid #dbe3ec;background:#f7f9fc;border-radius:5px;padding:5mm;margin-bottom:5mm}',
  '.finding p{margin:2mm 0 0;font-size:9.5px}','.two-col{display:grid;grid-template-columns:1fr 1fr;gap:5mm}','.report-block{margin:5mm 0;break-inside:avoid}',
  '.report-block h3,.chain h3{font-size:11px;color:#17345d;border-bottom:1px solid #d9e3ef;padding-bottom:2mm;margin:0 0 3mm}','.prose{white-space:pre-wrap;font-size:9px;color:#27384d}',
  ...
  '.legend{display:grid;grid-template-columns:45mm 1fr;gap:2mm 4mm;margin-top:6mm;padding:4mm;background:#fbfcfe;border:1px solid #e0e6ed;border-radius:5px;font-size:8px}.legend b{color:#17345d}',
  '.timeline-cards .cards{margin-top:2mm}','.occurrences th{background:#17345d;color:#fff;text-align:left;padding:2mm;font-size:7px}','.occurrences td{padding:2mm;border-bottom:1px solid #dfe5ec}',
  '.occurrences tr:nth-child(even){background:#f7f9fc}','.governance{margin-top:6mm;padding:4mm;background:#fff8e7;border-left:3px solid #d49b25;font-size:8px;color:#4b3b1a;break-inside:avoid}',
  '.confidence{margin-top:8mm;padding:6mm;border:1px solid #cbd8e6;border-radius:5px;background:#f7f9fc}','.confidence-label{font-size:7px;color:#2f62d0;font-weight:800;letter-spacing:.08em}',
  '.confidence h3{margin:2mm 0;font-size:12px;color:#17345d}','.confidence p{margin:0;font-size:9px;white-space:pre-wrap}','.appendix-title{border-bottom:2px solid #17345d;padding-bottom:5mm;margin-bottom:5mm}',
  '.appendix-title h1{font-size:22px;color:#17345d;margin:1mm 0}','.appendix-meta{font-size:8px;color:#718096}','.appendix-analysis{font-family:Arial,Helvetica,sans-serif;white-space:pre-wrap;font-size:8.5px;line-height:1.48;color:#26384c}',
  'table{page-break-inside:auto}','tr{page-break-inside:avoid;page-break-after:auto}','@media print{body{print-color-adjust:exact;-webkit-print-color-adjust:exact}}',
].join('');
