...
const REPORT_CSS = [
  ...
  'html,body{margin:0;padding:0;background:WHITE_BG;color:TEXT;color:#172334;font-family:Arial,Helvetica,sans-serif;font-size:10px;line-height:1.45}',
  '.page{width:210mm;min-height:297mm;position:relative;page-break-after:always;background:WHITE_BG;padding:23mm 16mm 18mm}',
  '.page:last-child{page-break-after:auto}',
  '.page>header{position:absolute;left:16mm;right:16mm;top:9mm;display:flex;justify-content:space-between;font-size:8px;font-weight:800;color:HEADER;color:#17345d;border-bottom:1px solid BORDER;padding-bottom:5px}',
  '.page>header span{font-weight:500;color:MUTED}',
  '.page>header b{margin-left:12px;color:HEADER}',
  '.page>main{min-height:255mm}',
  '.page>footer{position:absolute;left:16mm;right:16mm;bottom:8mm;border-top:1px solid BORDER;padding-top:4px;font-size:7.5px;color:MUTED;display:flex;justify-content:space-between}',
  '.cover-page{width:210mm;height:297mm;page-break-after:always;background:NAVY}',
  '.cover{height:297mm;background:NAVY;color:WHITE;padding:22mm 17mm 15mm;position:relative;overflow:hidden}',
  '.cover:before{content:"";position:absolute;left:0;top:0;bottom:0;width:5mm;background:ACCENT}',
  ...
  '.cover-kicker{margin-top:42mm;color:LIGHT_BLUE;font-weight:800;letter-spacing:.18em;font-size:9px}',
  '.cover h1{font-size:28px;line-height:1.02;letter-spacing:.02em;margin:4mm 0 7mm}',
  '.cover-id{font-size:13px;font-weight:800}',
  '.cover-subtitle{font-size:10px;color:LIGHT_TEXT;margin-top:3mm}',
  '.cover-rule{height:1px;background:#9aa9bf;margin:27mm 0 7mm}',
  '.brief-label{font-size:8px;font-weight:800;letter-spacing:.08em;color:LIGHT_BLUE}',
  '.cards{display:grid;grid-template-columns:repeat(4,1fr);gap:4mm;margin:6mm 0}',
  '.metric{background:#f4f7fb;color:TEXT;border-radius:5px;padding:4mm;min-height:18mm}',
  '.metric span{display:block;font-size:7px;color:MUTED;font-weight:800;letter-spacing:.06em}',
  '.metric strong{display:block;margin-top:2mm;font-size:11px;overflow-wrap:anywhere}',
  '.cover .metric:first-child{background:ACCENT_RED;color:WHITE}',
  '.cover .metric:first-child span{color:WHITE}',
  '.cover-window{display:grid;grid-template-columns:34mm 1fr;gap:3mm 5mm;margin-top:9mm;font-size:8.5px}',
  '.cover-window b{color:LIGHT_TEXT;font-size:7px;text-transform:uppercase}',
  '.cover-window span{font-weight:700}',
  '.cover-foot{position:absolute;left:17mm;right:17mm;bottom:14mm;color:LIGHT_TEXT;font-size:7.5px}',
  '.cover-foot span{float:right}',
  '.section-title{display:flex;align-items:center;gap:3mm;margin-bottom:2mm}',
  '.section-title span{width:2mm;height:7mm;border-radius:1mm;background:ACCENT}',
  '.section-title h2{margin:0;font-size:13px;color:HEADER}',
  '.eyebrow{font-size:8px;color:MUTED;margin:2mm 0}',
  '.page-heading{font-size:20px;color:HEADER;margin:1mm 0 7mm}',
  '.small-label{font-size:7px;color:MUTED;font-weight:800;letter-spacing:.06em}',
  '.info-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:3mm;margin-bottom:5mm}',
  '.info-grid>div{border:1px solid BORDER;border-radius:4px;padding:3.5mm;background:#f7f9fc;min-height:15mm}',
  '.info-grid b{display:block;margin-top:2mm;font-size:10px}',
  '.blue{color:#2861c7}',
  '.finding{border:1px solid BORDER;background:#f7f9fc;border-radius:5px;padding:5mm;margin-bottom:5mm}',
  ...
  '.report-block h3,.chain h3{font-size:11px;color:HEADER;border-bottom:1px solid #d9e3ef;padding-bottom:2mm;margin:0 0 3mm}',
  ...
  '.chain{background:#f7f9fc;border:1px solid BORDER;border-radius:5px;padding:4mm;margin-top:6mm}',
  ...
  '.legend b{color:HEADER}',
  '.timeline-cards .cards{margin-top:2mm}',
  '.occurrences th{background:HEADER;color:WHITE;text-align:left;padding:2mm;font-size:7px}',
  ...
  '.confidence-label{font-size:7px;color:ACCENT;font-weight:800;letter-spacing:.08em}',
  '.confidence h3{margin:2mm 0;font-size:12px;color:HEADER}',
  '.confidence p{margin:0;font-size:9px;white-space:pre-wrap}',
  '.appendix-title{border-bottom:2px solid HEADER;padding-bottom:5mm;margin-bottom:5mm}',
  '.appendix-title h1{font-size:22px;color:HEADER;margin:1mm 0}',
  '.appendix-meta{font-size:8px;color:MUTED}',
...
const REPORT_CSS_FIXED = REPORT_CSS
  .replaceAll('WHITE_BG', '#fff').replaceAll('TEXT', '#172334').replaceAll('HEADER', '#17345d').replaceAll('MUTED', '#718096')
  .replaceAll('BORDER', '#dbe3ec').replaceAll('NAVY', '#14284a').replaceAll('ACCENT', '#2f62d0')
  .replaceAll('LIGHT_BLUE', '#72a9ff').replaceAll('LIGHT_TEXT', '#91a1b8').replaceAll('ACCENT_RED', '#f26a6a');
