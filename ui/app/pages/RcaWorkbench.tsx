  ...
  const analyze = useCallback(async (requestedId: string): Promise<void> => {
    ...
    try {
      ...
      const normalized: Result = {
        ...
        definitiveRootCause: Boolean(asText(pa.rootCauseEntityId)),
        analysis,
