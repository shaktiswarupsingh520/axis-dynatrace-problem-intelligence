...
function reportHtml(result: Result): string {
  ...
  const page = (number: number, label: string, content: string) => `<article class="page"><header><div>AXIS BANK <span>| ApMoSys TECHNOLOGIES</span></div><div>${escapeHtml(label)} <b>${number} / 7</b></div></header><main>${content}</main><footer>Axis Davis Problem Intelligence &nbsp;|&nbsp; AI-assisted incident RCA &nbsp;|&nbsp; Confidential</footer></article>`;
